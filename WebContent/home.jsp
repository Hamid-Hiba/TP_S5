    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        ...
        <li class="nav-item">
            ...
            <h8 class="nav-link active" >Bienvenue , ${user.username}</8>
          </li>
          ...
          <li class="nav-item">
            ...
            <a class="nav-link active" href="home.jsp">Les locataires</a>
          </li>
          <li class="nav-item">
          
            <a class="nav-link active" href="home.jsp">Les propriétaires </a>
          </li>
              ...
              <div class="row">
                <div class="col-lg-8">
                  ...
                  <!--    <h1 class="intro-title mb-4">
                      <span class="color-b">204 </span> IRFANE
                      <br> A ne pas rater !</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">A louer | 2000 DH</span></a>-->
                    </p>
                  </div>
                </div>
              </div>
